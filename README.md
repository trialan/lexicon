...
3. Currently the code in translate.py is set to translate to Spanish, just change the request there. Find your language code [here](https://www.deepl.com/docs-api/translate-text).
